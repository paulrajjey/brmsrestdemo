...
<ul style="list-style:none;line-height:28px;">
	...
	<li>
    <spring:url value="/caseMgmt/" var="caseDefList" htmlEscape="true" />
		<a href="${caseDefList}">New case</a>
	</li>
	...
	<li>
    <spring:url value="/caseinstance/" var="caseInstanceList" htmlEscape="true" />
		<a href="${caseInstanceList}">Active Cases</a>
	</li>
